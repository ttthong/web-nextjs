...
const ProductCategories: NextPage = () => {
  return (
    <header className="self-stretch h-[151px] flex flex-row items-end justify-start pt-0 px-0 pb-[13px] box-border max-w-full text-left text-6xl text-black font-inter">
